  ...
  // 域级前缀规则：覆盖整个 finance.* 命名空间
  {
    ...
    metadata: {
      aliases: [
        ...
        // 自动取消订阅（省钱型）
        "cancel subscription", "unsubscribe", "stop auto renewal", "cancel renewal",
        "save money", "money saved",
        "退订", "取消订阅", "别自动续费", "关闭自动续费", "不想续费了", "省钱",
        "省了多少", "退掉", "不想订了", "嫌麻烦",
        // 账单管理（追踪 / 提醒 / 预算）
        "bills", "bill tracking", "bill reminder", "due date", "utility bill",
        "rent", "credit card payment", "recurring bills", "fixed expenses",
        "账单管理", "账单提醒", "缴费提醒", "到期日", "到期提醒", "缴费",
        "水电费", "燃气费", "物业费", "话费", "宽带费", "房租", "信用卡还款",
        "还款日", "固定支出", "该交什么钱",
      ],
      negativeAliases: [
      ...
      examples: [
        ...
        "how much money did i save by unsubscribing",
        "add a rent bill due on the 1st every month",
